...
/**
 * Loop {@link BfMaAstNode}.
 */
public class Loop extends BfMaAstNode {
    /** Default serialVersionUID. */
    private static final long serialVersionUID = 1L;

    /** Instructions to loop. */
     ...
     * @param begin begin
     * @param end end
     * @param characters instructions to loop
     */
    public Loop(final Location begin, final Location end, final ArrayList<BfMaAstNode> characters) {
        super(begin, end);
    ...
    /**
     * Returns the instructions to loop.
     * 
     * @return the instructions to loop
     */
