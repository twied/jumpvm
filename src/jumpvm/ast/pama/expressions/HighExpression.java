...
/** High {@link Expression}. */
public class HighExpression extends Expression {
     ...
     */
    public HighExpression(final Location begin, final Location end, final Designator designator, final int dimension) {
        super(begin, end);
