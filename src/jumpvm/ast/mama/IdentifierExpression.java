...
public class IdentifierExpression extends Expression {
    ...
    /**
     * Create a new IdentifierExpression.
     * 
     * @param begin begin
     * @param end end
     * @param identifier identifier
     */
    public IdentifierExpression(final Location begin, final Location end, final String identifier) {
        super(begin, end);
